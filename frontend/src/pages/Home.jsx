    ...
    <div className='min-h-screen bg-slate-50'>
      ...
      <section className='flex flex-col lg:flex-row items-center justify-between px-8 pt-40 pb-24 gap-12 max-w-7xl mx-auto mb-10'>
        ...
        >
          ...
          <motion.h1
            ...
            className='text-3xl sm:text-5xl font-bold text-slate-900 leading-tight'
          >
      ...
      <footer className='bg-primary border-t border-white/10 py-4 px-8'>
        <div className='max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4'>
          <p className='text-white/40 text-sm'>© {new Date().getFullYear()} PactPay.</p>
          <p className='text-white'>Built by <span className='text-accent'>Sajjad Ali</span></p>
          <div className='flex items-center gap-3'>
